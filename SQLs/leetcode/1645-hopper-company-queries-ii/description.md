...
<pre>
working_percentage = (number of distinct drivers with at least one accepted ride that month / number of active drivers that month) * 100
</pre>

<p>An <strong>active driver</strong> for a given month is one who joined Hopper on or before the last day of that month.</p>
