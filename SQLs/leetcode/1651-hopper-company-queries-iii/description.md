...
<p>Return the result table ordered by <code>month</code> in <strong>ascending</strong> order, where <code>month</code> is the starting month's number (January is <code>1</code>, February is <code>2</code>, etc.).</p>
